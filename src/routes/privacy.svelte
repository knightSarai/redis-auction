<article class="prose mx-auto">
	...
	<ul>
		...
		<li>
			<p>
				<strong>Website</strong> refers to Redis Auction, accessible from
				<a href="" rel="external nofollow noopener" target="_blank"></a>
			</p>
		</li>
		<li>
			<p>
	...
	<ul>
		<li>
			By visiting this page on our website: <a href="" rel="external nofollow noopener" target="_blank"></a>
		</li>
	</ul>
</article>
